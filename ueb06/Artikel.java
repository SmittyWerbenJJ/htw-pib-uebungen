...
public class Artikel {
   ...
   * @throws IllegalArgumentException wenn menge<0
   */
  public void bucheZugang(int menge) {
    if (menge >= 0) {
      this.bestand += menge;
    } else {
      throw new IllegalArgumentException("Zugangsmenge kann nicht negativ oder 0 sein!");
    }
  }
   ...
   * @throws IllegalArgumentException wenn versucht wird mehr abzubuchen als
   *                                  vorhanden ist
   */
  public void bucheAbgang(int menge) {
    if ((menge >= 0) && (menge <= this.bestand) && (this.bestand > 0)) {
      ...
      throw new IllegalArgumentException("Kein Bestand oder nicht genügend Artikel zuer entahme verfügbar!");
    }
  }
